...
def romp_settings(input_args=sys.argv[1:]):
    ...
    if not os.path.exists(args.smpl_path):
        smpl_url = 'https://github.com/ZaiqiangWu/ROMP/releases/download/V2.0/smpl_packed_info.pth'
        download_model(smpl_url, args.smpl_path, 'SMPL')
    if not os.path.exists(args.model_path):
        romp_url = 'https://github.com/ZaiqiangWu/ROMP/releases/download/V2.0/ROMP.pkl'
        download_model(romp_url, args.model_path, 'ROMP')
    if not os.path.exists(args.model_onnx_path) and args.onnx:
        romp_onnx_url = 'https://github.com/ZaiqiangWu/ROMP/releases/download/V2.0/ROMP.onnx'
